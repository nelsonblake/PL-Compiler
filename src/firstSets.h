...
static const StopSet firstSimpleExpression = {Symbol::SUBTRACTION_OPERATOR, Symbol::EPSILON};
...
static const StopSet firstPrimaryExpression = {Symbol::SUBTRACTION_OPERATOR, Symbol::EPSILON};
static const StopSet firstPrimaryOperator = {Symbol::AND_OPERATOR, Symbol::OR_OPERATOR};
static const StopSet firstExpression = {Symbol::SUBTRACTION_OPERATOR, Symbol::EPSILON};
static const StopSet firstGuardedCommand = {Symbol::SUBTRACTION_OPERATOR, Symbol::EPSILON};
static const StopSet firstGuardedCommandList = {Symbol::SUBTRACTION_OPERATOR, Symbol::EPSILON};
...
static const StopSet firstExpressionList = {Symbol::SUBTRACTION_OPERATOR, Symbol::EPSILON};
